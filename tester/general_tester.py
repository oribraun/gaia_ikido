...
from pipeline.schema.outputs import IkidoClassifierOutputs
...
from tester.evaluator import IkidoClassifierEvaluator


class IkidoClassifierGeneralTester(DS_Tester):

    def __init__(self):
        DS_Tester.__init__(self)
        self.ready = False
        self.pipeline = IkidoClassifierPipeline()
        self.evaluator = IkidoClassifierEvaluator()
    ...
    def create_model_request(self, batch_input_rows) -> IkidoClassifierInputs:
        """
        ...
        model_request = IkidoClassifierInputs()
...
if __name__ == '__main__':
    ...
    tester = IkidoClassifierGeneralTester()
    args = sys.argv[1:]
